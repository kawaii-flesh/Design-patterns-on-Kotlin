...
class FileDataProvider(val dataProvider: IDataProvider = StandartDataProvider()): IDataProvider
{
    ...
    override fun registerOpperation() = dataProvider.registerOpperation()
}

class RemoteDataProvider(val dataProvider: IDataProvider = StandartDataProvider()): IDataProvider
{
    override fun getData(): Array<Int>
    {
